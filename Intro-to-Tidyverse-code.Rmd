...
Find a complete compilation of text_spec("R", color = "blue") text_spec("color",color = "red") text_spec("palettes",color = "purple") [here](https://github.com/EmilHvitfeldt/r-color-palettes)
